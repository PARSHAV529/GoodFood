...
export const ProductsSummaryCard = ({ product }) => {
    ...
    return (
        <div className="flex justify-between w-2/3 lg:h-40 h-20  border border-gray-300 rounded-md shadow-sm hover:shadow-lg transition duration-300 ease-in-out">
            ...
            <div className="flex-1 flex flex-col  ">
                <div className="flex  justify-between items-start ">
                    ...
                    <h3 className="lg:text-2xl mt-2 text-[0.8rem] md:text-lg lg:m-3 font-bold">{capitalizeFirstLetter(product.name)}</h3>
                   
                   
                    <div className="lg:text-lg text-[0.8rem] sm:text-sm font-semibold mt-5 sm:mt-8 lg:mt-20">{`${product.price}₹`}</div>
                    <div className="h-7 w-20 flex justify-center items-center mt-5 scale-75 ml-3 sm:scale-90 lg:scale-125 sm:mt-8 lg:mt-20 sm:mr-5 lg:mr-10 ">
